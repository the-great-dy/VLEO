...
METRIC_KEYS = [
    ...
    "high_value_delivery_rate_count",
    "high_value_delivery_rate_value_weighted",
    "high_value_process_rate_count",
    "high_value_process_rate_value_weighted",
    "high_value_expired_rate_count",
    "high_value_expired_rate_value_weighted",
    "processed_mean_mb",
    "downlink_mean_mb",
